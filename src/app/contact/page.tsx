    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          ...
          {/* Embedded Google Map */}
          <div className="rounded-3xl overflow-hidden border border-zinc-800 h-64 relative bg-zinc-950">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15761.547382741!2d38.7883!3d8.9953!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x164b85cef0ab1555%3A0x889812480!2sBole%20Medhanealem%2C%20Addis%20Ababa!5e0!3m2!1sen!2set!4v1700000000000!5m2!1sen!2set"
              width="100%"
              height="100%"
              ...
              title="Abis Production Studio Office Google Map"
            />
          </div>
        </div>
      </div>
